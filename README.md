...
- B站真实登录 Chrome 已加载当前生产包：网站语言下拉、双语字幕、点击定位、单句/循环/连续、0.8×、上/下一句、同视频双标签页和第 1 P→第 2 P→第 1 P 状态重建均通过。真实样本每个分 P 不足 5 分钟，因此 B站 20 分钟轴仍明确标记为模拟；整体 ≥20 分钟真实定位由 YouTube 21 分钟样本覆盖。
